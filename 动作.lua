...
local animations = {
	...
	{name = "圣经天使", id = 109873544976020, speed = 1, timepos = 0, looped = true, freezeonend = false},
	...
	{name = "Skibidi马桶", id = 127154705636043, speed = 1, timepos = 0, looped = true, freezeonend = false},
	{name = "滚动哭宝", id = 129699431093711, speed = 1, timepos = 0, looped = true, freezeonend = false},
	...
	{name = "附身", id = 90708290447388, speed = 1, timepos = 0, looped = true, freezeonend = false},
