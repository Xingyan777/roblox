...
local Window = WindUI:CreateWindow({
    Size = UDim2.new(0, 580, 0, 400),
    Window.UIElements.Topbar.Size = UDim2.new(1, 0, 0, 40)
Window.UIElements.SideBarContainer.Size = UDim2.new(0, Window.SideBarWidth, 1, -94)
Window.UIElements.Main.Size = UDim2.new(1, -Window.UIElements.SideBarContainer.AbsoluteSize.X, 1, -52)
Window.UIElements.Main.UIPadding.PaddingBottom = UDim.new(0, 12)
